// Deploy SecOps Steward Agent Function App
...
var functionAppName = 'sosagent${appNamePrefix}'
var appServiceName = 'sosagentappsvc${appNamePrefix}'
var appInsightsName = 'sosagentinsights${appNamePrefix}'
