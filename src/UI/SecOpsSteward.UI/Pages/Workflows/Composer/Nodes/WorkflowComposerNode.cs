...
namespace SecOpsSteward.UI.Pages.Workflows.Composer.Nodes
{
    ...
    {
        public WorkflowComposerNode(string id, PluginMetadataModel package, double x, double y) : base(id, new Point(x, y))
        {
        ...
        private void ApplyPackage(PluginMetadataModel package)
        {
            ...
            var positions = new PortAlignment[] {
        ...
        public Dictionary<string, OutputPort> ResultPorts => Ports.OfType<OutputPort>().Cast<OutputPort>().ToDictionary(k => k.OutputCode, v => v);
    }
