...
namespace SecOpsSteward.Data.Models
{
    public class ManagedServiceModel
    {
        ...
        public ManagedServiceModel() { }
        public static ManagedServiceModel FromMetadata(ServiceMetadata svc, PluginMetadata[] plugins) =>
            new ManagedServiceModel()
            {

                ManagedServiceId = svc.ServiceId.GetComponents(PackageIdentifierComponents.Container | PackageIdentifierComponents.Service),
                Name = svc.Name,
