...
namespace SecOpsSteward.Plugins.Azure.AppServices.Functions
{
    public class AzureFunctionServiceConfiguration : AzureSharedConfiguration, IConfigurableObjectConfiguration
    {
        ...
        internal Task<IFunctionApp> GetAppAsync(IAzure azure) => azure.AppServices.FunctionApps.GetByResourceGroupAsync(ResourceGroup, FunctionAppName);
    }
    ...
    public class AzureFunctionService : SOSManagedService<AzureFunctionServiceConfiguration>
    {
        ...
        private static WorkflowTemplateDefinition TEMPLATE_SWAP_OUT_BACK =>
            new WorkflowTemplateDefinition<AzureFunctionService, SlotSwapWorkflowConfiguration>("Perform Slot Swap")
                .RunWorkflowStep<AzureFunctionSlotSwap>(
                    nameof(SlotSwapWorkflowConfiguration.OriginalSlot).MapsTo(nameof(AzureFunctionSlotSwapConfiguration.SourceSlot)),
                    nameof(SlotSwapWorkflowConfiguration.TemporarySlot).MapsTo(nameof(AzureFunctionSlotSwapConfiguration.DestinationSlot)))
                .RunAnyChildWorkflows()
                .RunWorkflowStep<AzureFunctionSlotSwap>(
                    nameof(SlotSwapWorkflowConfiguration.TemporarySlot).MapsTo(nameof(AzureFunctionSlotSwapConfiguration.SourceSlot)),
                    nameof(SlotSwapWorkflowConfiguration.OriginalSlot).MapsTo(nameof(AzureFunctionSlotSwapConfiguration.DestinationSlot)));


        private static WorkflowTemplateDefinition TEMPLATE_SWAP_OUT_BACK_WITH_CONFIG_CHANGE =>
            new WorkflowTemplateDefinition<AzureFunctionService, SlotSwapWorkflowConfiguration>("Perform Slot Swap With Configuration Update")
                .RunWorkflowStep<AzureFunctionSlotSwap>(
                    nameof(SlotSwapWorkflowConfiguration.OriginalSlot).MapsTo(nameof(AzureFunctionSlotSwapConfiguration.SourceSlot)),
                    nameof(SlotSwapWorkflowConfiguration.TemporarySlot).MapsTo(nameof(AzureFunctionSlotSwapConfiguration.DestinationSlot)))
                .RunAnyChildWorkflows()
        ...
        private static WorkflowTemplateDefinition TEMPLATE_RESET_KEY =>
            new WorkflowTemplateDefinition<AzureFunctionService, AzureFunctionKeyResetConfiguration>("Reset Function Key")
                .RunWorkflowStep<AzureFunctionKeyReset>(
                    nameof(AzureFunctionKeyResetConfiguration.FunctionKeyName).MapsTo(nameof(AzureFunctionKeyResetConfiguration.FunctionKeyName)));


        private static WorkflowTemplateDefinition TEMPLATE_SET_CONFIG =>
            new WorkflowTemplateDefinition<AzureFunctionService, SetFunctionConfigurationConfiguration>("Set Function Configuration")
                .RunWorkflowStep<SetFunctionConfiguration>(
