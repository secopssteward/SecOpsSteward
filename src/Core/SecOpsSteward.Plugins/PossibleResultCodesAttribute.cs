...
{
    /// <summary>
    /// Attribute declaring possible output results from the annotated Plugin; "Success" and "Failure" are included by default
    /// </summary>
    ...
    public class PossibleResultCodesAttribute : Attribute
    {
        ...
        {
            Outputs = outputs.Concat(new string[] { CommonResultCodes.Success, CommonResultCodes.Failure }).Distinct().ToArray();
        }
    }
