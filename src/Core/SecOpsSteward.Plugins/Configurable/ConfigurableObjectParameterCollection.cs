    ...
    public class ConfigurableObjectParameterCollection
    {
        ...
        public string ApplyToStringTemplate(string template)
        {
            ...
            foreach (var param in Parameters)
                emulatedStructure.SharedOutputs.SecureOutputs.Add("Configuration." + param.Name, param.Value == null ? "" : param.Value.ToString());
        ...
        /// </summary>
        public List<ConfigurableObjectParameter> Parameters { get; set; } = new List<ConfigurableObjectParameter>();
        ...
        public ConfigurableObjectParameterCollection(IDictionary<string, object> dictionary) : this(dictionary.Select(d => new ConfigurableObjectParameter() { Name = d.Key, Value = d.Value })) { }

        /// <summary>
        /// Representation of all Parameters and values as a Dictionary
        /// </summary>
        public IDictionary<string, object> AsDictionary() => Parameters.ToDictionary(k => k.Name, v => v.Value);
        ...
        /// </summary>
        public bool GrantScopeValuesPopulated => !Parameters.Where(p => p.DefinesAuthorizationScope).Any(p => IsValueEmpty(p.Value));
        ...
        /// </summary>
        public string AsSerializedString() => JsonSerializer.Serialize(AsDictionary());
        ...
        public static ConfigurableObjectParameterCollection CreateFromObject<TConfiguration>(TConfiguration obj) =>
            new ConfigurableObjectParameterCollection(
        ...
        public ConfigurableObjectParameterCollection Clone() =>
            new ConfigurableObjectParameterCollection(this.Parameters.Select(p => p.Clone()));
