...
namespace SecOpsSteward.Plugins.Configurable
{
    ...
    public interface IConfigurableObject { }; // implies TConfiguration Configuration property
    public static class ConfigurableObjectConfigurationExtensions
    {
        ...
        public static string PopulateStringTemplate(this IConfigurableObjectConfiguration config, string template)
        {
            ...
            foreach (var param in config.AsDictionaryProperties())
                emulatedStructure.SharedOutputs.SecureOutputs.Add("Configuration." + param.Key, param.Value == null ? "" : param.Value.ToString());
        ...
        public static IConfigurableObjectConfiguration Merge(this IConfigurableObjectConfiguration configA, string name, object value) =>
            Merge(configA, new Dictionary<string, object>() { { name, value } });
        ...
        /// <returns>Merged configuration</returns>
        public static IConfigurableObjectConfiguration Merge(this IConfigurableObjectConfiguration configA, IConfigurableObjectConfiguration configB) =>
            Merge(configA, configB.AsDictionaryProperties());
        ...
        /// <returns>Merged configuration</returns>
        public static IConfigurableObjectConfiguration Merge(this IConfigurableObjectConfiguration configA, Dictionary<string, object> configBDictionary)
        {
    ...
    public static class IConfigurableObjectExtensions
    {
        ...
        public static IConfigurableObjectConfiguration GetBlankConfiguration(this IConfigurableObject basis) =>
            Activator.CreateInstance(basis.GetConfigurationType()) as IConfigurableObjectConfiguration;
        ...
        public static TConfigurable WithConfiguration<TConfigurable, TConfiguration>(this TConfigurable target, TConfiguration config)
        ...
        /// <returns>Configured object</returns>
        public static TConfigurable WithConfiguration<TConfigurable>(this TConfigurable target, IDictionary<string, object> dictionaryConfig)
            where TConfigurable : IConfigurableObject => target.WithConfiguration(dictionaryConfig.AsObject(target.GetConfigurationType()) as IConfigurableObjectConfiguration);
        ...
        public static Dictionary<string, object> GetConfigurationAsDictionary(this IConfigurableObject basis) =>
            basis.GetConfigurationObject().AsDictionaryProperties();
        ...
        public static ConfigurableObjectParameterCollection GetConfigurationDescription(this IConfigurableObject basis) =>
            ConfigurableObjectParameterCollection.CreateFromObject(Activator.CreateInstance(basis.GetConfigurationType()));
    }
}
