...
namespace SecOpsSteward.Plugins
{
    ...
    public interface IManagedServicePackage : IConfigurableObject, IHasDescriptiveMetadata
    {
        ...
        /// </summary>
        /// <returns>List of named PluginConfigurations which can be used with this Plugin</returns>
        Task<List<DiscoveredServiceConfiguration>> Discover(List<DiscoveredServiceConfiguration> existingDiscoveries, bool includeSecureElements = false);
    }
    ...
    {
        public static IPlugin CreatePlugin(this IManagedServicePackage package, IServiceProvider services, Guid pluginId, IConfigurableObjectConfiguration config = null)
        {
        ...
        public static IPlugin CreatePlugin(this IManagedServicePackage package, IPlugin plugin, IConfigurableObjectConfiguration config = null)
        {
            var baseConfiguration = package.GetConfigurationObject();
