...
namespace SecOpsSteward.Plugins.WorkflowTemplates
{
    public class WorkflowTemplateParticipantDefinition
    {
        ...
        public WorkflowTemplateParticipantDefinition(Guid packageId, Dictionary<string, string> mappings) : this(mappings)
        {
            PackageId = packageId;
        }

        public static WorkflowTemplateParticipantDefinition DependentFlowParticipant =>
            new WorkflowTemplateParticipantDefinition();

        public override string ToString() => $"Workflow Step '{WorkflowStepName}' ({PackageId})";
    }
