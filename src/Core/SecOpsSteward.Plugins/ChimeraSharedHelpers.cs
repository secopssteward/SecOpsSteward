...
{
    /// <summary>
    /// Commonly used commands for Plugins
    /// </summary>
    public static class PluginSharedHelpers
    {
        /// <summary>
        ...
        public static byte[] GetHash(params byte[][] byteSets) =>
            GetHash(byteSets.SelectMany(b => b).ToArray());
        ...
        public static byte[] SerializeToBytes<T>(T obj) =>
            Encoding.UTF8.GetBytes(SerializeToString(obj));
        ...
        public static T GetFromSerializedBytes<T>(byte[] bytes) =>
            GetFromSerializedString<T>(Encoding.UTF8.GetString(bytes));
        ...
        public static object GetFromSerializedBytes(byte[] bytes, Type targetType) =>
            GetFromSerializedString(Encoding.UTF8.GetString(bytes), targetType);
        ...
        public static object GetFromSerializedString(string str, Type targetType) =>
            JsonSerializer.Deserialize(str, targetType);
