...
namespace SecOpsSteward.Plugins
{
    ...
    public class PluginOutputStructure
    {
        ...
        /// Outputs to pass on
        /// </summary>
        public PluginSharedOutputs SharedOutputs { get; set; } = new PluginSharedOutputs();
        ...
        public string this[string key] { get => SharedOutputs[key]; set => SharedOutputs[key] = value; }

        /// <summary>
        /// Create an output structure based on a result code
        /// </summary>
        /// <param name="resultCode">Result code</param>
        public PluginOutputStructure(string resultCode) => ResultCode = resultCode;
        ...
        public class PluginSharedOutputs
        {
            ...
            /// </summary>
            public Dictionary<string, string> SecureOutputs { get; set; } = new Dictionary<string, string>();
            ...
            public bool Contains(string key) => SecureOutputs.ContainsKey(key) || Outputs.ContainsKey(key);
            ...
            public T As<T>(string key) => JsonSerializer.Deserialize<T>(this[key]);
            ...
            public void Set<T>(string key, T val) => this[key] = JsonSerializer.Serialize(val);
            ...
            /// <param name="key">Output name</param>
            /// <param name="val">Output value</param>
            public void SetPublicly<T>(string key, T val) => Outputs[key] = JsonSerializer.Serialize(val);
            ...
            public PluginSharedOutputs AsScrubbedCollection() =>
                new PluginSharedOutputs() { Outputs = new Dictionary<string, string>(Outputs) };
            ...
            public PluginSharedOutputs WithPurged(string wildcard, bool secureOnly = true) => WithPurged(WildcardToRegex(wildcard), secureOnly);
